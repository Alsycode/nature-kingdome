...
/* ── Custom dark topographic SVG map ────────────────────────────── */
    ...
    >
      <defs>
        ...
        <radialGradient id="lake" cx="50%" cy="50%" r="50%">
          ...
          <stop offset="100%" stopColor="#111e2a" />
        </radialGradient>
      ...
      {/* ── Terrain patches (elevation areas) ── */}
      ...
      {/* Inner contours (closer to center) */}
      ...
      <path d="M225,273 Q295,244 365,222 Q430,205 490,200 Q554,196 602,212 Q650,230 672,260 Q688,282 694,312 Q700,342 676,366 Q638,398 575,403 Q471,413 368,402 Q290,393 228,370 Q190,350 225,273Z"
        fill="none" stroke="#c8a84b" strokeWidth="0.6" opacity="0.38" />

      {/* Innermost tight contours */}
      ...
      <path d="M308,235 Q368,222 428,210 Q484,200 538,200 Q592,201 628,220 Q660,240 668,268 Q677,295 676,320 Q675,345 655,362 Q622,386 562,389 Q462,398 362,386 Q302,376 272,350 Q253,326 308,235Z"
        fill="none" stroke="#c8a84b" strokeWidth="0.7" opacity="0.45" />
      ...
      {/* ── Area labels ── */}
      {/* Pine Forest - top center */}
      <text x="375" y="72" textAnchor="middle" fill="#c8a84b" fillOpacity="0.55"
        fontSize="11" fontFamily="'Hanken Grotesk', sans-serif" letterSpacing="2" fontWeight="300">
        Pine
      </text>
      ...
      {/* Whispering Falls - left */}
      <text x="95" y="258" textAnchor="middle" fill="#c8a84b" fillOpacity="0.5"
        fontSize="10" fontFamily="'Hanken Grotesk', sans-serif" letterSpacing="1.5" fontWeight="300">
        Whispering
      </text>
