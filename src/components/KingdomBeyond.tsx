...
// High-end topographical contour mapping background
  ...
  return (
    ...
    >
      <svg className="w-full h-full stroke-[#e9c349]" viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Second group representing lakes and valley contours */}
...
export default function KingdomBeyond() {
  ...
  // We track scroll progress on the massive container element.
  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: ["start start", "end end"]
  });

  // Calculate horizontal translate mapping (e.g., from 0% left to -80% left based on number of columns)
  // On desktop, we'll have: Intro Screen (100vw) + 4 Chapter Screens (4 * 100vw) + Outro Screen (100vw) = 6 screens.
  // We'll slide by -83.333% (5/6 screen-widths) to reveal everything.
  ...
  return (
    <div ref={containerRef} className="relative h-[480vh] lg:h-[550vh] bg-surface lg:-ml-20 lg:w-[calc(100%+5rem)]" id="kingdom-beyond">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-between">
        ...
        {/* Dynamic topographical mapping system background */}
        <TopographicalCurves progress={scrollYProgress} />

        {/* Decorative Top subtle watermark */}
            ...
            >
              ...
              <div className="grid grid-cols-12 gap-12 items-center w-full max-w-7xl mx-auto z-10">
                ...
                <div className="col-span-6 relative aspect-[4/5] bg-surface-container-highest overflow-hidden select-none shadow-2xl">
                  ...
                  {/* Absolute positioning of vertical title in image container */}
                ...
                {/* Narrative Typography Block (Col-span-6) */}
                <div className="col-span-6 pl-12 flex flex-col justify-center space-y-12">
                  ...
                  {/* Curated list of sights without traditional box cards (pure lines) */}
              ...
              {/* Huge Background chapter numbering watermark */}
        ...
        {/* MOBILE LAYOUT (STYLISH VERTICAL SCROLL STACK) */}
